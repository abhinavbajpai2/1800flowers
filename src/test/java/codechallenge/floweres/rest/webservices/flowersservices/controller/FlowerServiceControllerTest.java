package codechallenge.floweres.rest.webservices.flowersservices.controller;
...
import codechallenge.floweres.rest.webservices.flowersservices.FlowersServiceController;
...
@SpringBootTest
public class FlowerServiceControllerTest {
	...
	@Autowired
	FlowersServiceController flowerServiceController;
	...
	public void getUniqueUsersCountTest() {
		...
		assertEquals(10, flowerServiceController.getUniqueUsersCount().getUniqueUserCount());
	...
	public void retrieveUpdatedUserTest() {
		...
		when(flowerService.retrieveJsonAsList()).thenReturn(getJsonObjects());
		assertEquals(param, flowerServiceController.updateUser(param).getTitle());
		assertEquals(param, flowerServiceController.updateUser(param).getBody());
	}
